...
try {
    ...
    $conn->query("INSERT INTO kawan_main_ff (nama, kelas, tgl_lahir) VALUES ('John', '3', '2006-07-03')");
    $conn->query("INSERT INTO kawan_main_ff (nama, kelas, tgl_lahir) VALUES ('Mary', '3', '2006-01-03')");
    $conn->query("INSERT INTO kawan_main_ff (nama, kelas, tgl_lahir) VALUES ('Julie', '3', '2006-04-03')");
